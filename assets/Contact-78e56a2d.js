import{j as e,n as c,p as d,q as x,s as m,F as t,P as o,k as p,N as j,C as f}from"./index-bb940453.js";import{P as u}from"./PageHero-10209713.js";import"./index-9c8ca60f.js";const h=[{title:"ADDRESS",content:[{icon:e.jsx(c,{}),info:["1800 Abbot Kinney Blvd. Unit D & E Venice"]}]},{title:"CONTACT",content:[{icon:e.jsx(d,{}),info:["Mobile: (+88) – 1990 – 6886","Hotline: 1800 – 1102"]},{icon:e.jsx(x,{}),info:["Mail: contact@okipull.com"]}]},{title:"HOUR OF OPERATION",content:[{icon:e.jsx(m,{}),info:["Sunday & Saturday: 10:30 – 22:00","Monday – Friday : 09:00 – 20:00"]}]}];function g(){return e.jsx(y,{children:h.map(({content:n,title:s})=>e.jsxs("div",{className:"space-y-6",children:[e.jsx("h1",{className:"font-semibold",children:s}),n.map(({icon:l,info:r},a)=>e.jsxs(C,{children:[e.jsx("div",{className:"text-2xl",children:l}),e.jsx("div",{children:r.map(i=>e.jsx("h1",{children:i},i+a))})]},"info"+a))]},s))})}const y=t.div`
grid
sm:grid-cols-3
grid-cols-1
gap-y-8
