import{F as o,r as i,j as e,R as l,M as j,N as b,C as y}from"./index-beec69c4.js";import{P as C}from"./PageHero-1d212a87.js";function c(t){const{bg:x,title:m,text:d,btn:p,children:u}=t,[h,g]=i.useState({}),a=i.useRef([]),f=s=>{s.preventDefault(),a.current.map(n=>{g(r=>({...r,[n.name]:n.value}))}),console.log(h)};return e.jsxs(v,{className:x,children:[e.jsx("h1",{className:"text-4xl",children:m}),e.jsx("h1",{className:"text-lightGray",children:d}),e.jsxs("form",{onSubmit:f,className:"flex w-[80%] flex-col",children:[e.jsx(N,{children:l.Children.map(u,(s,n)=>l.cloneElement(s,{ref:r=>a.current[n]=r}))}),e.jsx(j,{children:e.jsx("button",{children:p})})]})]})}const v=o.div`
p-10
flex
flex-col
items-center
