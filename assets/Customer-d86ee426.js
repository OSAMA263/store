import{F as a,r as i,j as e,R as l,M as j,N as g,C as b}from"./index-c5e3681c.js";import{P as y}from"./PageHero-fe19a256.js";function c(t){const{bg:x,title:m,text:d,btn:p,children:u}=t,[E,h]=i.useState({}),o=i.useRef([]),f=s=>{s.preventDefault(),o.current.map(n=>{h(r=>({...r,[n.name]:n.value}))})};return e.jsxs(C,{className:x,children:[e.jsx("h1",{className:"text-4xl",children:m}),e.jsx("h1",{className:"text-lightGray",children:d}),e.jsxs("form",{onSubmit:f,className:"flex w-[80%] flex-col",children:[e.jsx(v,{children:l.Children.map(u,(s,n)=>l.cloneElement(s,{ref:r=>o.current[n]=r}))}),e.jsx(j,{children:e.jsx("button",{children:p})})]})]})}const C=a.div`
p-10
flex
flex-col
items-center
