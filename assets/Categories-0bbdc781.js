import{F as Y,Q as ne,j as o,y as Q,s as se,a4 as re,g as ie,r as V,N as ae,P as oe,O as ce}from"./index-4c0e8422.js";import{P as ue}from"./PageHero-fd4d88ee.js";import"./index-6223acf0.js";function le(l){const{cat:h,thumbnail:f}=l,S=ne().filter($=>$.category===h);return o.jsxs(o.Fragment,{children:[o.jsx(de,{thumbnail:f}),o.jsxs("div",{className:"flex items-center justify-between h-[20%]",children:[o.jsxs("div",{className:"leading-6 transition-all duration-700 sm:text-xl btn-visible",children:[o.jsx("h1",{className:"transition-all duration-700 text-lightGray",children:h}),o.jsx(Q,{to:"/shop",className:"duration-700 opacity-0 text-thickRed",children:"+ Online store"})]}),o.jsxs("div",{className:"flex items-center gap-x-4",children:[o.jsx(fe,{}),o.jsx("small",{children:S.length})]})]})]})}const de=({thumbnail:l})=>o.jsxs(Q,{to:"/shop",className:"h-[80%] relative overflow-hidden",children:[o.jsx(he,{}),o.jsx("div",{className:"xl:h-[600px] md:h-[400px] h-[300px] relative",children:o.jsx(se,{styles:"!object-center !absolute !top-0 !w-full !h-full !transition-all !duration-700",placeholder:!0,effect:!0,src:l})})]}),he=Y.div`
img-border
w-[80%]
h-[80%]
absolute
